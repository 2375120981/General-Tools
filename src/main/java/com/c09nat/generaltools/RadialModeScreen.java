...
public class RadialModeScreen extends Screen {
    ...
    public void render(GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        graphics.drawCenteredString(font, Component.literal("AUTO"),
        ...
        for (int i = 0; i < MODES.length; i++) {
            ...
            } else if (!tool.isEmpty()) graphics.renderItem(tool, x, y);
            else graphics.drawCenteredString(font, "×", x + 8, y + 4, enabled ? 0xFFFFFF : 0x777777);
        }
